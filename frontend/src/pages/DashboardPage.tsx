...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      upcomingMatchesApi
        .getAll()
        .then((r) => setUpcomingMatches(r.data.matches)),
      predictionApi
        .getMyPredictions()
        .then((r) => setMyPredictions(r.data.predictions)),
    ])
      .catch(console.error)
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center p-4">
        ...
        >
          ...
          >
            Watch a short sponsored video to unlock all predictions and
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      color: isPaused ? "rgba(255,255,255,0.5)" : "#F5C518",
                    }}
                  >
                    {timeLeft}s
                  </span>
    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-gray-400 mt-1">
          Here's your prediction competition overview
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
            ...
            {[
              {
                key: "r32Points",
                label: "Round of 32",
                max: ROUND_POINTS.ROUND_OF_32 * 16,
              },
              {
                key: "r16Points",
                label: "Round of 16",
                max: ROUND_POINTS.ROUND_OF_16 * 8,
              },
              {
                key: "r8Points",
                label: "Round of 8",
                max: ROUND_POINTS.ROUND_OF_8 * 4,
              },
              {
                key: "qfPoints",
                label: "Quarter Final",
                max: ROUND_POINTS.QUARTER_FINAL * 2,
              },
              {
                key: "sfPoints",
                label: "Semi Final",
                max: ROUND_POINTS.SEMI_FINAL * 2,
              },
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link
              to="/predict"
              className="text-[#F5C518] hover:text-[#FFD700] text-sm flex items-center gap-1"
            >
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
          {[
            ...
            {
              rank: 9,
              prize: "Official WC Jersey",
              sub: "Authentic edition",
              accent: null,
              border: "",
            },
            {
              rank: 10,
              prize: "Special Hamper",
              sub: "inal Whistle 2026 goodies pack",
              accent: null,
              border: "",
            },
        ...
        <div className="card">
          ...
          >
            {[
              {
                num: 1,
                text: "Rankings are determined entirely by total points earned across all rounds.",
                tag: "Points-based",
                tagBg: "#E1F5EE",
                tagColor: "#085041",
              },
              {
                num: 2,
                text: "Each correct prediction earns points according to the round — higher rounds carry more weight. Predictions cannot be changed after a match kicks off.",
                tag: null,
              },
              {
                num: 3,
                text: "If two or more participants finish with equal points, a tiebreaker quiz will be held between them to determine final ranking.",
                tag: "Quiz tiebreaker",
                tagBg: "#EEEDFE",
                tagColor: "#3C3489",
              },
              {
                num: 4,
                text: "If scores remain tied even after the quiz, the winner will be decided by a fair lottery conducted publicly and transparently.",
                tag: "Lottery",
                tagBg: "#FAEEDA",
                tagColor: "#633806",
              },
              {
                num: 5,
                text: "All participants must abide by decisions made by the inal Whistle 2026 authority. Authority decisions are final and binding in all matters.",
                tag: "Authority final",
                tagBg: "#FCEBEB",
                tagColor: "#791F1F",
              },
              {
                num: 6,
                text: "Any attempt to manipulate predictions, exploit system vulnerabilities, or engage in unfair conduct will result in immediate disqualification without appeal.",
                tag: null,
              },
              {
                num: 7,
                text: "Winners will be announced after the FIFA World Cup 2026 Final. Prize distribution details will be communicated directly to winners by the inal Whistle 2026 authority.",
                tag: null,
              },
