  ...
  return (
    <div className="min-h-screen">
      ...
      <aside
        ...
        bg-[#151529] text-white border-r border-gray-200 flex flex-col
        transform transition-transform duration-300 lg:translate-x-0
        ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`}
      >

        {/* Logo */}
        <div className="flex items-center justify-between px-5 py-[41px] border-b border-gray-200 shrink-0">
          <div className="flex items-center gap-3">
            {/* <div className="w-10 h-10 rounded-xl bg-[#d254f0] grid place-items-center">
              <Trophy className="w-5 h-5 text-white" />
            </div> */}
            <div>
              <div className="font-bold text-2xl leading-tight text-white">Final Whistle 2026</div>
        ...
        {/* Nav */}
        <div className="flex-1 justify-between overflow-y-auto px-3 py-4 flex flex-col gap-6">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all
                    ${active
                      ? "bg-[#d254f0] text-white shadow-sm"
          ...
          <div className="px-1">
            ...
            <a
              href={currentAd.href}
              className="relative block h-40 rounded-2xl overflow-hidden group ring-1 ring-gray-200 shadow-md hover:shadow-lg transition"
            >
              <img
                key={currentAd.image}
                src={currentAd.image}
        ...
        <div className="border-t border-gray-200 p-4 shrink-0">
          ...
          <button
            ...
            rounded-xl bg-gray-100 hover:bg-gray-200 text-black text-sm font-medium"
          >
      ...
      <div className="lg:pl-72">
        ...
        {/* Sponsor Marquee */}
        <div className="sticky top-0 z-30 bg-[#151529] border-b border-gray-200">
        ...
        <div className="sticky top-[7.05rem] z-30 bg-[#111827] text-white overflow-hidden border-b py-2 border-gray-800  flex gap-10 text-sm font-medium">
        ...
        <main className="p-6 bg-[#f3f3f9]">{children}</main>
      </div>
